...
- The 2026-09-08 whole-page composition uses the same report and graph. The
  ...
  map, beside the accepted external communication observations. Each group initially shows five
