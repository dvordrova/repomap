...
func Operations() table.Definition {
	return table.Definition{Stage: StageOperations, Contract: "repomap.atlas.operations.v13", System: operationsPrompt, Independent: true, Memoize: true, Columns: []table.Column{
