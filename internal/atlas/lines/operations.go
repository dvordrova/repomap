...
func Operations() table.Definition {
	return table.Definition{Stage: StageOperations, Contract: "repomap.atlas.operations.v12", System: operationsPrompt, Independent: true, Memoize: true, Columns: []table.Column{
